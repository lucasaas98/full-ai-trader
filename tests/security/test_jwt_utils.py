...
@pytest.fixture
def jwt_manager(jwt_config: Any) -> Any:
...
class TestJWTPayload:
    ...
    def test_payload_creation(self, sample_payload: Dict[str, Any]) -> None:
...
class TestJWTManager:
    ...
    def test_manager_initialization(self, jwt_config: Any) -> None:
    ...
    def test_create_access_token(
        self, jwt_manager: Any, sample_payload: Dict[str, Any]
    ) -> None:
    ...
    def test_create_refresh_token(self, jwt_manager: Any) -> None:
    ...
    def test_decode_expired_token(self, jwt_manager: Any) -> None:
    ...
    def test_decode_invalid_token(self, jwt_manager: Any) -> None:
    ...
    def test_extract_roles_and_permissions(
        self, jwt_manager: Any, sample_payload: Dict[str, Any]
    ) -> None:
    ...
    def test_is_token_expired(self, jwt_manager: Any) -> None:
    ...
    def test_refresh_access_token(self, jwt_manager: Any) -> None:
    ...
    def test_refresh_with_invalid_token(self, jwt_manager: Any) -> None:
...
class TestJWTUtilityFunctions:
    ...
    def test_extract_user_id_from_request_header(self, jwt_manager: Any) -> None:
    ...
    def test_validate_token_from_header(self, jwt_manager: Any) -> None:
    ...
    def test_global_jwt_manager(self) -> None:
...
class TestJWTSecurity:
    ...
    def test_different_secret_keys(self) -> None:
    ...
    def test_algorithm_security(self) -> None:
    ...
    def test_audience_validation(self, jwt_manager: Any) -> None:
    ...
    def test_issuer_validation(self, jwt_manager: Any) -> None:
    ...
    def test_token_expiration_scenarios(self, jwt_manager: Any) -> None:
    ...
    def test_custom_expiration(self, jwt_manager: Any) -> None:
...
class TestJWTIntegration:
    ...
    def test_service_to_service_auth(self, jwt_manager: Any) -> None:
    ...
    def test_user_session_auth(self, jwt_manager: Any) -> None:
    ...
    def test_api_key_auth(self, jwt_manager: Any) -> None:
    ...
    def test_token_refresh_flow(self, jwt_manager: Any) -> None:
...
class TestJWTErrorHandling:
    ...
    def test_malformed_secret_key(self) -> None:
    ...
    def test_token_creation_with_invalid_config(self) -> None:
    ...
    def test_decode_with_none_verification(self, jwt_manager: Any) -> None:
...
class TestJWTEnvironmentIntegration:
    ...
    def test_environment_config_loading(self) -> None:
    ...
    def test_missing_jwt_secret_fallback(self) -> None:
...
class TestJWTSecurityBestPractices:
    ...
    def test_token_timing_consistency(self, jwt_manager: Any) -> None:
    ...
    def test_token_uniqueness(self, jwt_manager: Any) -> None:
